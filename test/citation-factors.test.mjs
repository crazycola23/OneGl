...
test("candidate features keep observable factors in explicit buckets", () => {
...
test("factor analysis reports baseline, uplift and Wilson intervals", () => {
  ...
  const positionOne = analysis.factors.find(
    (row) => row.factor === "candidate_position" && row.bucket === "1",
  );
